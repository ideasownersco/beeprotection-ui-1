export const ACTION_TYPES = {
  ...
  FETCH_WORKING_ORDERS_REFRESH_REQUEST: '@company/orders/FETCH_WORKING_ORDERS_REFRESH_REQUEST',

  FETCH_UPCOMING_ORDERS_REQUEST: '@company/orders/FETCH_UPCOMING_ORDERS_REQUEST',
  FETCH_UPCOMING_ORDERS_SUCCESS: '@company/orders/FETCH_UPCOMING_ORDERS_SUCCESS',
  FETCH_UPCOMING_ORDERS_FAILURE: '@company/orders/FETCH_UPCOMING_ORDERS_FAILURE',

  FETCH_UPCOMING_ORDERS_REFRESH_REQUEST: '@company/orders/FETCH_WORKING_ORDERS_REFRESH_REQUEST',
  ...
  FETCH_PAST_ORDERS_REFRESH_REQUEST: '@company/orders/FETCH_PAST_ORDERS_REFRESH_REQUEST',
