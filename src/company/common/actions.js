export const ACTION_TYPES = {
  FETCH_JOB_ORDERS_REQUEST: '@company/FETCH_JOB_ORDERS_REQUEST',
  FETCH_JOB_ORDERS_SUCCESS: '@company/FETCH_JOB_ORDERS_SUCCESS',
  FETCH_JOB_ORDERS_FAILURE: '@company/FETCH_JOB_ORDERS_FAILURE',
  FETCH_JOB_ORDERS_REFRESH_REQUEST: '@company/FETCH_JOB_ORDERS_REFRESH_REQUEST',
  ...
  FETCH_UPCOMING_ORDERS_REFRESH_REQUEST:
    '@company/FETCH_JOB_ORDERS_REFRESH_REQUEST',
...
function fetchWorkingOrders(params) {
  return {
    type: ACTION_TYPES.FETCH_JOB_ORDERS_REQUEST,
    params,
  };
}
...
function fetchWorkingOrdersRefresh(params) {
  return {
    type: ACTION_TYPES.FETCH_JOB_ORDERS_REFRESH_REQUEST,
    params,
  };
}
