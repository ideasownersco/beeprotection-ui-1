...
export const ACTION_TYPES = {
  ...
  SUBSCRIBE_TO_JOB_TRACK: '@customer/SUBSCRIBE_TO_ORDER_TRACKING',
  ...
  FETCH_UPCOMING_ORDERS_REFRESH_REQUEST:
    '@customer/FETCH_JOB_ORDERS_REFRESH_REQUEST',

  FETCH_JOB_ORDER_REQUEST: '@customer/FETCH_JOB_ORDER_REQUEST',
  FETCH_JOB_ORDER_SUCCESS: '@customer/FETCH_JOB_ORDER_SUCCESS',
  FETCH_JOB_ORDER_FAILURE: '@customer/FETCH_JOB_ORDER_FAILURE',
...
function fetchWorkingOrder(params) {
  return {
    type: ACTION_TYPES.FETCH_JOB_ORDER_REQUEST,
    params,
  };
}
